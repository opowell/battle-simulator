// ---------------------------------------------------------------------------
// Fog-of-war belief tracking for StarCraft 1.
//
...
export function getSc1Belief(state, myId) {
  ...
  if (!belief) {
    ...
    belief = new Sc1Belief(myId, state.board, enemyUnits, enemyBuildings);
