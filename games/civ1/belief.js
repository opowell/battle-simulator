// ---------------------------------------------------------------------------
// Fog-of-war belief tracking for Civ1 — a stateful information-set tracker,
...
export function getCiv1Belief(state, myId) {
  ...
  if (!belief) {
    ...
    belief = new Civ1Belief(myId, state.board, enemyUnits, enemyCities);
