...
//
//   node games/chess/calibrate-belief.mjs [--max-games N] [--seat white|black|both]
//
...
//
// sessions/ is untracked and lives at the repo root; a fresh worktree needs it
// symlinked or this exits with a clear message rather than an ENOENT stack.
// ---------------------------------------------------------------------------
