...
Production default is now **FITTED_WEIGHTS** ([movePrior.js](movePrior.js)),
regenerated by [fit-move-prior.mjs](fit-move-prior.mjs). The 2026-07-30 section
...
Reproduce with `node games/chess/fit-move-prior.mjs --e2e [--ablate]`. Everything
