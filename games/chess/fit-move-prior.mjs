...
//
//   node games/chess/fit-move-prior.mjs                 # fit + cross-validate
//   node games/chess/fit-move-prior.mjs --e2e           # + belief log-loss, held out
//   node games/chess/fit-move-prior.mjs --e2e --ablate  # + per-term ablations
//   node games/chess/fit-move-prior.mjs --write         # update FITTED_WEIGHTS
//   node games/chess/fit-move-prior.mjs --actor human   # fit one opponent type
//
...
import { genFogMoves, fromBoardObject } from './exactBelief.js';
...
if (!existsSync(SESSIONS)) {
  console.error(`No sessions/ at ${SESSIONS}.\n` +
    'It is untracked and lives at the repo root — symlink it into this worktree first.');
  process.exit(1);
}
